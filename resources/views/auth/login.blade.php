                        ...
                        <div class="card overflow-hidden z-index-1">
                            <div class="card-body p-0">
                                <div class="row g-0 h-100">
                                    <div class="col-md-5 text-center" style="background-color: #5C67A2;">
...
<style>
    .adminimg{
        object-fit: contain;
                                                ...
                                                <img height="300" width="200" src="{{ asset('image/logo.avif') }}" alt="New Image" class="adminimg">
                                            </div>
                                        </div>
                                            ...
                                            <form id="loginForm" method="POST" action="{{ route('login') }}">
                                              ...
                                              {{-- <!-- Google reCAPTCHA -->
                                                ...
                                                <div class="mb-3"><button
                                                        ...
                                                        name="submit"  style="background-color: #5C67A2; border-color: #5C67A2;">{{ __('Login') }}</button></div>
                                            </form>
