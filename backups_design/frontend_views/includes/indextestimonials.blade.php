...
<style>
  ...
  .traveller-stories-section .extralarger {
    color: #fff;
  }
  .traveller-stories-section .testimonial-card {
    background: rgba(255, 255, 255, 0.04);
    border: 1px solid rgba(201, 161, 90, 0.2);
  }
  .traveller-stories-section .testimonial-card h5 {
    color: #fff;
  }
  .traveller-stories-section .testimonial-card .text-muted {
